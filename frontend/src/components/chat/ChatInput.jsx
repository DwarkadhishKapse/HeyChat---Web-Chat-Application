...
const ChatInput = ({ onSend, onSendFile, chatId, socket }) => {
  ...
  // handle input change and also typing socket events
  ...
  // when user press "Escape" button, emoji picker close
  useEffect(() => {
    const escListener = (e) => {
      if (e.key === "Escape") {
        setShowEmojiPicker(false);
  ...
  const handleEmojiClick = (emojiData) => {
    ...
    const updatedMessage = textBefore + emoji + textAfter;
    setMessage(updatedMessage);

    // here restoring cursor position after emoji insert
    setTimeout(() => {
      inputRef.current.focus();
      inputRef.current.selectionStart = inputRef.current.selectiveEnd =
  ...
  // this function handles file selection and preview logic
  ...
  return (
    <div className="relative">
      ...
      {/* This is Preview UI for image, video, file */}
      {selectedFile && (
